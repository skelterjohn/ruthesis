...
The \alg{BOSS} and \alg{BFS3} algorithms were both run in \env{Texture World}, and the results are shown in Figure~\ref{sec:expr:tworld-reward} and in Figure~\ref{sec:expr:tworld-time}.
