...
%% chronological order
\begin{achievementlist}{1999--2004}
\item[1999--2004] B.~Sc. in Computer Science from Rutgers University
\end{achievementlist}
%
%% List of positions held since the last undergraduate degree (in reverse
%% chronological order).
\begin{achievementlist}{xxxx--xxxx}
\item[2011] Intern, Sarnoff Corporation
\item[2010] Intern, AT\&T Research
\item[2006--2012] Teaching Assistant, Rutgers University
\item[2009--2012] Graduate Assistant, Rutgers University
\end{achievementlist}
%
