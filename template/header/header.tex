...
\newcommand{\titletext}{Model-based Bayesian reinforcement learning}
...
\newcommand{\safetitletext}{Model-based Bayesian reinforcement learning}
\providecommand{\safetitletext}{\titletext}
\newcommand{\authortext}{John Asmuth}
