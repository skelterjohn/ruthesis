...
\newcommand{\bed}{$B$-$\epsilon$-$\delta$}
\newcommand{\bsed}{$B$-$\sigma$-$\epsilon$-$\delta$}
\newcommand{\dBeta}{\mbox{Beta}}
\newcommand{\dBin}{\mbox{Bin}}
\newcommand{\dBern}{\mbox{Bernoulli}}

\providecommand{\note}[1]
    {\marginpar{\LARGE zzz}\textcolor{red}{$\ll${\bf #1}$\gg$}}

\providecommand{\reply}[1]
    {\marginpar{\LARGE new}\textcolor{blue}{#1}}
